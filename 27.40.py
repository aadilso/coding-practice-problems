...
# Hints:
#
# Don't forget to declare Ascend3's parameters as pass-by-reference (using &). Otherwise, the function won't be able to change the values of the passed arguments.
...
# Note: Don't assign the parameters right away, because you'll overwrite a value that is still needed.
#
